#!/usr/bin/env bash
# Print a deterministic hash of every repository input that affects the ESP32
# firmware image. Build output under firmware/dist is intentionally excluded
# because it is gitignored and is the thing this hash is used to validate.
set -Eeuo pipefail
